          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:items-start">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div className="flex flex-col items-center justify-center gap-1 rounded-xl border bg-warning/5 py-3 text-center ring-1 ring-inset ring-warning/15">
                ...
                <div className="flex flex-col items-center justify-center gap-1 rounded-xl border bg-muted/40 py-3 text-center">
                ...
                <StaggerChildren className="space-y-2.5" staggerMs={30} initialDelayMs={0}>
                  {positionTurnout.map((item) => (
                    <div
                      ...
                      className={cn(
                        'rounded-xl border bg-muted/20 px-3.5 py-3 transition-colors',
